...
public class C03_DataProvider {
    ...
    @Test(dataProvider = "AranacakKelimeler")// data saglayici, once burayi yaz!! sonra yukarda array olustur notasyonla beraber
    public void dataProviderTesti(String arananKelime) {//ic aray 2 taneyse burda 2 parametre girilmesi lazim
